        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="diaryForm" onsubmit="return updateDiary(event)">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tags" name="tags" 
                                   value="<?= htmlspecialchars(implode(', ', $diary['tags'])) ?>"
...
function updateDiary(event) {
    ...
    .then(data => {
        if (data.success) {
            ...
            alert(data.error || '<?= __('diary.update_error') ?>');
        }
    })
    .catch(error => {
